...
class ComponentServiceTest extends BaseDatabaseSuite {
    ...
    void test_addComponent() {
        ...
        final var componentService = new ComponentService(databaseManager, routerMock);
        ...
        componentService.addComponent(notLogic);
    ...
    void test_removeComponent() {
        ...
        // Delete Component
        // ----------------------
        componentService.removeComponent(componentMock);
    ...
    void test_addPin_lastIndex() {
        executeSqlFile(new File("src/test/resources/sql/testCases/ComponentServiceTest-joinerLogic.sql"));
        ...
        final var componentService = new ComponentService(databaseManager, mock(Router.class));
        final var newPin = componentService.addPin(connector);
    ...
    void test_addPin_specificIndex() {
        ...
        final var newPin = componentService.addPin(connector, 1); // add at 1st index
    ...
    void test_addPin_and_then_removePin() {
        ...
        // Action #1
        final var newPin = componentService.addPin(connector, 1);
        // Action #2
        final var newPin2 = componentService.addPin(connector, 1);
        // Action #3
        final var deletedPin = componentService.removePin(connector, 0);
