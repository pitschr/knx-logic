...
/**
 * <p>Annotation for 'Output' fields for declaration that the field
 * is designed to send values to other component via the connector
...
public @interface Output {
    ...
    /**
     * <p>Minimum of output values that can be hold by {@link Pin}.</p>
     *
